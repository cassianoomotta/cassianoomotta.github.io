    ...
    >
      ...
      <main className="ai-container hero-layout" style={{ flex: 1, padding: '2rem 0' }}>
        ...
        <div className="hero-text-col">
          ...
          <p style={{ fontSize: '1.08rem', color: 'var(--text-dim)', maxWidth: '580px', lineHeight: 1.6, marginBottom: '3rem' }}>
            Administrador e Mestrando na FURG focado em <strong>Governança de Dados, Vibe Coding e Inteligência Artificial</strong>. Transformo fluxos de dados e agentes autônomos em soluções de software de alto impacto e prontas para produção.
          </p>
        ...
        <div className="hero-visual-col" style={{ flexDirection: 'column', alignItems: 'center' }}>
          {/* Badge de Localização sobre a foto */}
