...
`Next.js 16` • `React` • `Python` • `FastAPI` • `Gemini API` • `Multi-Agent AI` • `Prisma ORM` • `SQL` • `NextAuth` • `Pytest` • `Vibe Coding`

---

<p align="center">
  <i>Construindo o futuro do software com velocidade e Inteligência Artificial. 🟩</i>
</p>
